    ...
    <div class="w-60 bg-blue-900 text-white flex flex-col shadow-current rounded-md">
        ...
        <nav class="mt-2 flex-1 overflow-y-auto">
          <ul>
            ...
            <li>
              <SidebarLink href="/users" :active="isActive('/users')" :class="{'bg-blue-500':isActive('/users'),'text-white':true}">
                <template #icon>
            ...
            <li>
              <SidebarLink href="/roles" :active="isActive('/roles')" :class="{'bg-blue-500':isActive('/roles'),'text-white':true}">
                <template #icon>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
            ...
            <li>
              <SidebarLink href="/permissions" :active="isActive('/permissions')" :class="{'bg-blue-500':isActive('/permissions'),'text-white':true}">
                <template #icon>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
