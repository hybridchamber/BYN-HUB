<template>
    ...
    <div class="w-60 bg-blue-700 text-white flex flex-col shadow-current rounded-md">
        ...
        <nav class="mt-2 flex-1 overflow-y-auto">
          <ul>
            <li>
              <SidebarLink href="/admins" :active="isActive('/admins')" :class="{'bg-blue-900':isActive('/admins'),'text-white':true}">
                <template #icon>
            ...
            <li>
              <SidebarLink href="/users" :active="isActive('/users')" :class="{'bg-blue-900':isActive('/users'),'text-white':true}">
                <template #icon>
            ...
            <li>
              <SidebarLink href="/roles" :active="isActive('/roles')" :class="{'bg-blue-900':isActive('/roles'),'text-white':true}">
                <template #icon>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
            ...
            <li>
              <SidebarLink href="/permissions" :active="isActive('/permissions')" :class="{'bg-blue-900':isActive('/permissions'),'text-white':true}">
                <template #icon>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
            ...
            <li>
              <SidebarLink href="/posts" :active="isActive('/posts')" :class="{'bg-blue-900':isActive('/posts'),'text-white':true}">
                <template #icon>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
              ...
              <SidebarLink href="/bulletinboards" :active="isActive('/bulletinboards')" :class="{'bg-blue-900':isActive('/bulletinboards'),'text-white':true}">
                <template #icon>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
              ...
              <SidebarLink href="/youthprofiles" :active="isActive('/youthprofiles')" :class="{'bg-blue-900':isActive('/youthprofiles'),'text-white':true}">
                <template #icon>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
      ...
      <div class="flex-1 overflow-y-auto bg-white border-separate h-full shadow-inner" style="background-image: url('/image/Design (2).png'); background-size: cover; background-position: center; ">
        <slot></slot>
      </div>
    </div>
